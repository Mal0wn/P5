...
function initPage () {
    ...
    let nameTeddy = document.getElementsByClassName("title_teddy");    //recupérer elt qui porte name teddy
    ...
    let picTeddy = document.getElementsByClassName("img_produit");     // recuperer elt qui porte l'img 
    ...
    let descripTeddy = document.getElementsByClassName("description"); // recuperer elt qui porte la description
    ...
    for (let color of selectedTeddy.colors) {
        let eltCol = document.createElement('option');
